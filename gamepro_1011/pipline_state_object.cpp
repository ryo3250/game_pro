...
[[nodiscard]] bool pipline_state_object:: create(const device& device, const shader& shader, const root_signature rootSignature) noexcept
{
	...
	const D3D12_RENDER_TARGET_BLEND_DESC defailtRenderTargetBlendDesc =
	{
		FALSE,
		FALSE,
		D3D12_BLEND_ONE,
	...
	{
		blendDesc.RenderTarget[i] = defailtRenderTargetBlendDesc;
	}
